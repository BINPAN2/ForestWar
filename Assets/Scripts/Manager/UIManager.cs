...
public class UIManager:BaseManager {
    ...
    private UIPanelType UIPanelTypetoPush = UIPanelType.None;
    ...
    {
        if (UIPanelTypetoPush != UIPanelType.None)
        {
            PushPanel(UIPanelTypetoPush);
            UIPanelTypetoPush = UIPanelType.None;
        }
    }
